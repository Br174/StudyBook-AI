    ...
    <main className="app-shell">
      <header className="hero">
        <div className="hero-copy">
          <span className="eyebrow">STUDYBOOK AI · v0.11</span>
      ...
      <section className="panel import-panel">
        <div>
          ...
          <p>PDF, DOCX, EPUB, TXT e fotografie. Le immagini servono solo come sorgente OCR: non vengono conservate nel libro di studio.</p>
        </div>
      ...
      {scanPages.length > 0 && (
        <section className="panel scan-basket">
          <div className="scan-basket-head">
            <div><span className="eyebrow dark">SCANSIONI</span><h2>{scanPages.length} {scanPages.length === 1 ? 'pagina' : 'pagine'} · {scanReadyCount} pronte</h2><p>Le foto sono temporanee: dopo l’OCR il progetto conserva il testo, non le immagini.</p></div>
      ...
      {cameraOpen && (
        <div className="camera-overlay" role="dialog" aria-modal="true" aria-label="Scanner pagina">
          <div className="camera-sheet">
            ...
            <p className="camera-help">La foto viene usata per l’OCR e resta solo nella raccolta temporanea. Nel libro di studio salviamo il testo.</p>
